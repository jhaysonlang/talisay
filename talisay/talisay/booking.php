		...
		<div class="content w3layouts-agileits">
			...
			<div class="services">
				<div class="container">
					...
					<img src="images/reservation_info.png">
					<h4 style="color:black;">To be able to create a reservation, you must log-in first your acccount.</h4>
					<h4><a href="../index_login.php">I already have an account.</a></h4>
					<h4><a href="../register.php">Create my account.</a></h4>
			</center>
		</div>
		</div>
	<!--footer-->

                ...
                <table id = "myTable" class="table table-striped table-bordered" >
                      ...
                      <?php
                       ...
                       while($row = mysql_fetch_array($qry)) {
                                echo '<tr>';
                  echo '<td><b>'. $row['transactionNo'] . '</b></td>';
                  ...
                  echo '<td>'. $row['status'].'';
				  if($row['status'] == 'Pending' AND ($_SESSION['usertype'] == 'Admin' OR $_SESSION['usertype'] == 'Receptionist' OR $_SESSION['usertype'] == 'Marketing') AND !empty($row['image']))
                  {
                  echo '&nbsp;';
                  echo '<img src = "glyph/check1.png" width = "20px" height = "20px" title = "Uploaded Receipt"></a>';
                  }
				  echo '</td>';
                  echo '<td>';
                  echo '<a href="read-reservation.php?id='.$row['transactionNo'].'"><img src = "glyph/read.png" width = "20px" height = "20px"  title = "Read"></a>';
				  
                  if($row['status'] == 'Pending' AND ($_SESSION['usertype'] == 'guest'))
                  {
                  echo '&nbsp;';
                  ...
                  {
                     echo '&nbsp;';
                      echo '<a href="../report/SOA.php?id='.$row['transactionNo'].'"><img src = "glyph/printer.png" width = "20px" height = "20px"  title = "Print"></a>';
